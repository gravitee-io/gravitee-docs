...
A plan provides a service and access layer on your API for the consumer link:/apim_overview_concepts.html#gravitee-concepts-application[applications].
...
image::apim/api-publisher-guide/plans-subscriptions/plan-diagram.png[Gravitee.io - Plan diagram, 873, 530, align=center, title-align=center]
...
To subscribe to a Plan, developers must create an link:/apim_overview_concepts.html#gravitee-concepts-application[application] and choose the Plan they want to subscribe.
