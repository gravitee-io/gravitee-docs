...
.Create
image::adminguide/newrole-create.png[Gravitee.io - Create a New Role, 873, 530, align=center, title-align=center]
...
.Configure
image::adminguide/newrole-configure.png[Gravitee.io - Configure a New Role, 873, 530, align=center, title-align=center]

=== Result
As expected, the user with this role can now only see the documentation menu.

.Menu
image::adminguide/newrole-menu.png[Gravitee.io - Menu, 873, 530, align=center, title-align=center]
