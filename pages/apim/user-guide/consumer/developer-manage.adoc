...
NOTE: Only users with correct role permission can manage application's members, see link:/apim_adminguide_roles_and_permissions.html[roles and permissions]
...
.Manage members
image::apim/api-consumer-guide/developer-manage/manage-members.png[Gravitee.io - manage members]
...
image::apim/api-consumer-guide/developer-manage/app-subscriptions.png[Gravitee.io - application subscriptions]
