...
[[gravitee-installation-gateway-configuration]]
...
* request: Client authentication is not required but can be if using <<apim_policies_ssl_enforcement.html, SSL enforcement policy>>
...
[source,yaml]
----
include::https://raw.githubusercontent.com/gravitee-io/gravitee-gateway/master/gravitee-gateway-standalone/gravitee-gateway-standalone-distribution/src/main/resources/config/gravitee.yml[]
----
