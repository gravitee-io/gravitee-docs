...
Mail templates configuration. Gravitee.io Management API use http://freemarker.org[Freemarker template engine] to parse and create the mail templates.
...
Here's the list of mail templates :

[width="100%",cols="20%,60%,20%",frame="topbot",options="header"]
|======================
|Mail Template                  |Description                                    |Variables
|apiGroupMember.html            |New API group member notification.             |username, *group*
|apiKeyExpired.html             |API Key expired notification.                  |*owner*, apiKey
|apiKeyRevoked.html             |API Key revoked notification.                  |*owner*, apiKey
|apiMember.html                 |New API member notification.                   |username, *api*
|applicationGroupMember.html    |New application group member notification.     |username, *group*
|applicationMember.html         |New application member notification.           |username, *application*
|subscriptionApproved.html      |API subscription approved notification.        |*owner*, *api*, *plan*
|subscriptionReceived.html      |API subscription received notification.        |*owner*, *api*, *plan*, *application*
|subscriptionRejected.html      |API subscription rejected notification.        |*owner*, *api*, *plan*
|userRegistration.html          |User registration notification.                |username, registrationUrl
|======================
...
|======================
|Api                |Application        |Group              |Plan               |Owner
