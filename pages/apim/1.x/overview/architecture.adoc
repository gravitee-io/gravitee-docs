...
image::{% link images/apim/1.x/architecture/graviteeio-global-architecture.png %}[Gravitee.io - Global Architecture]

.Gravitee.io - Platform Architecture
image::{% link images/apim/1.x/architecture/graviteeio-platform-architecture.png %}[Gravitee.io - Platform Architecture]
