...
:page-permalink: apim/1.x/apim_installguide_management_api.html
:page-folder: apim/installation-guide/management-api
:page-liquid:
:page-description: Gravitee.io API Management - Management API - Overview
...
[source,bash]
----
$ curl -L https://download.gravitee.io/graviteeio-apim/distributions/graviteeio-full-{{ site.products.apim.version }} -o gravitee-standalone-distribution-{{ site.products.apim.version }}.zip
----
