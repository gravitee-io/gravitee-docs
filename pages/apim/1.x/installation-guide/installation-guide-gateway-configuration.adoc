...
:page-description: Gravitee.io API Management - Gateway - Configuration
...
* request: Client authentication is not required but can be if using link:apim/1.x/apim_policies_ssl_enforcement.html[SSL enforcement policy]
