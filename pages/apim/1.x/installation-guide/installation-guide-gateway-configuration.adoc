...
[source,yaml]
----
include::https://raw.githubusercontent.com/gravitee-io/gravitee-gateway/1.30.31/gravitee-gateway-standalone/gravitee-gateway-standalone-distribution/src/main/resources/config/gravitee.yml[]
----
