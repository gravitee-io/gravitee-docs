...
curl -H "Authorization: Basic YWRtaW46YWRtaW4=" \
     ...
     -X POST \
     -d '{"name":"My First API","version":"1","description":"Gravitee.io Echo API Proxy","proxy":{"context_path":"/myfirstapi","endpoint":"https://api.gravitee.io/echo"}}' \
...
Your plan is in stagging state, in order to make it visible for everyone, you must publish it.
