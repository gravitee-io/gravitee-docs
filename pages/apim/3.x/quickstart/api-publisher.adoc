...
http://MANAGEMENT_UI_SERVER_DOMAIN (see link:/apim/3.x/apim_installguide_portal.html[Gravitee.io Management UI installation] for more information)
...
image::apim/3.x/graviteeio-create-api.png[]

.. Give your API a name, a version, a description and a context path

image::apim/3.x/graviteeio-create-first-api-1.png[]

[start=2]
.. Make sure that `Backend` is set to `https://api.gravitee.io/echo`

image::apim/3.x/graviteeio-create-first-api-2.png[]

[start=3]
.. Click `CREATE` button and your API is created

image::apim/3.x/graviteeio-first-api.png[]
...
image::apim/3.x/graviteeio-create-plan.png[]
...
image::apim/3.x/graviteeio-create-plan-2.png[]
...
image::apim/3.x/graviteeio-create-plan-3.png[]
...
image::apim/3.x/graviteeio-create-first-api-3.png[]
...
Your API is now ready to be use by your consumers. Let's see how to do this : link:/apim/3.x/apim_quickstart_consume.html[Use your first API]

This quick start was just an overview to create your first API. To go further into API management detail you can take a look at the link:/apim/3.x/apim_publisherguide_manage_apis.html[User Guide]
