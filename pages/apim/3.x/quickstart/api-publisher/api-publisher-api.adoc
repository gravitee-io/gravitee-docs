= Publish your first API with the REST API
...
This section walks you through creating and publishing your first API with the REST API. You can find more information in the link:/apim/3.x/apim_publisherguide_manage_apis.html[API Publisher Guide].
...
== Create your API with the REST API
