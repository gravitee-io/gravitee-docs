= Consuming an API with the REST API
...
This guide walks you through creating your first application and subscribing to your first API with the REST API. For a brief overview of how to set up your first API, see the *Publish your first API* section of the Quick Start Guide.
...
== Create your application with the REST API
