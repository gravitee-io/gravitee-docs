[[apim-kubernetes-controller-installation]]
= How to deploy the Kubernetes Controller plugin
:page-sidebar: apim_3_x_sidebar
:page-permalink: apim/3.x/apim_kubernetes_controller_installation.html
