...
Resources:
  ...
  * The `ManagementContext` CRD code is available on link:https://github.com/gravitee-io/gravitee-kubernetes-operator/blob//api/v1master1/managementcontext_types.go[GitHub^].
