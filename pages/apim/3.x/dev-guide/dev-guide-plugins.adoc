...
deploy the archives in ${GRAVITEE_HOME/plugins}. Refer to the link:/apim/3.x/apim_installguide_gateway_configuration.html#configure_the_plugins_repository[configuration documentation] for more information.
