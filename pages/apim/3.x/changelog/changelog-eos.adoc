= APIM End Of Support changelog
:page-sidebar: apim_3_x_sidebar
:page-permalink: apim/3.x/changelog-eos.html
:page-folder: apim
:page-toc: false
:page-layout: apim3x
...
- An organization user (and environment admin) can't delete a dictionary he has created https://github.com/gravitee-io/issues/issues/6556[#6556]
...
- When filtering through the logs, showing results as the maximum allows, and no other pages even though there are more results https://github.com/gravitee-io/issues/issues/6913[#6913]
...
- Possibility to disable promoted card on page list https://github.com/gravitee-io/issues/issues/6472[#6472]
...
- [data-logging-masking] data are no longer masked https://github.com/gravitee-io/issues/issues/6122[#6122]
...
- [generate-http-signature] Generate HTTP Signature policy https://github.com/gravitee-io/issues/issues/4899[#4899]
...
- Enhance certificate management in keystore to enable to differentiate certificates per domain https://github.com/gravitee-io/issues/issues/5894[#5894]
...
- Problem on registration of the proxy conf https://github.com/gravitee-io/issues/issues/5896[#5896]
...
- "order" field of Plans get reset when imported from 3.5.x to 3.8.x https://github.com/gravitee-io/issues/issues/5696[#5696]
...
- Check existence of confirmUrl https://github.com/gravitee-io/issues/issues/5567[#5567]
...
- Default_api_logo.png can not be overridden https://github.com/gravitee-io/issues/issues/5524[#5524]
...
- ResponseContainer Annotation does not work for `Page` and `PagedResult` https://github.com/gravitee-io/issues/issues/5289[#5289]
...
- [studio] scope is not automatically selected https://github.com/gravitee-io/issues/issues/4801[#4801]
...
- Newsletter improvement https://github.com/gravitee-io/issues/issues/4692[#4692]
...
- Avoid usage of URI.create to handle properly path and query parameters with special characters https://github.com/gravitee-io/issues/issues/4837[#4837]
...
- Adapt configuration to be more consistent with the mgmt config https://github.com/gravitee-io/issues/issues/3968[#3968]
