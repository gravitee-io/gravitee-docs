...
*_link:{{'/apim/3.x/apim_kubernetes_operator_overview.html' | relative_url }}[Beta - Gravitee Kubernetes Operator ]_*
...
*_link:{{'/apim/3.x/v4_new_policy_execution_engine_introduction.html' | relative_url }}[Beta - New gateway execution engine]_*
...
*_link:{{'/apim/3.x/event_native_apim_introduction.html' | relative_url }}[Alpha - Introducing Event-Native API Management]_*
