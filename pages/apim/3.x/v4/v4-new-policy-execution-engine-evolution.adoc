[[v4-new-policy-execution-engine-evolution]]
= V3 and V4  policy execution engines compared
...
As a result, the number of `500` errors should decrease after link:{{ 'apim/3.x/event_native_apim_new_policy_execution_engine_activation.html' | relative_url }}[activating] the new V4 policy execution engine mode.
