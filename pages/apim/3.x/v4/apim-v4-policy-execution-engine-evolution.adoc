[[apim-v4-policy-execution-engine-evolution]]
= Evolution from the existing V3 policy execution engine
:page-sidebar: apim_3_x_sidebar
:page-permalink: apim/3.x/apim_v4_policy_execution_engine_evolution.html
:page-folder: apim/v4
:page-layout: apim3x
