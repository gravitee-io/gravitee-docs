...
1. Download and import the following files into Postman.
    * link:/pages/apim/3.x/v4/Tutorials_Environment.postman_collection.json[Gravitee Tutorials Postman Environment]
    * link:/pages/apim/3.x/v4/Tutorials.postman_collection.json[Gravitee Tutorials Postman Collection]
