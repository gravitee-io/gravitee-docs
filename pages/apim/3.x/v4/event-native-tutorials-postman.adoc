...
1. Download and import the following files into Postman.
    * link:/apim/3.x/management-api/Tutorials_Environment.postman_collection.json[Gravitee Tutorials Postman Environment]
    * link:/apim/3.x/management-api/Tutorials.postman_collection.json[Gravitee Tutorials Postman Collection]
