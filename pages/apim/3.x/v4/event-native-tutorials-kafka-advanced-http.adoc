...
* The Enterprise edition of Gravitee API Management Gateway running in Docker, with the `kafka-advanced` plugin installed. To confirm it is running, go to `http://localhost:8084`.
