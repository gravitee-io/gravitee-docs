...
The quick install methods get APIM up and running quickly without any plugins. The custom install methods, and the image-based methods, give you more control over the location of persistence data and the ability to add plugins.
