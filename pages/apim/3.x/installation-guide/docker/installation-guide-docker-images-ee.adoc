= Docker Images Install (Enterprise Edition)
...
6. Install the API Management Gateway using the following commands.
+
[source,bash]
----
...
7. Install the API Management REST API using the following commands.
+
[source,bash]
----
...
8. Install the API Management Management UI using the following commands.
+
[source,bash]
----
...
9. Install the API Management Portal UI using the following commands.
+
[source,bash]
----
...
10. In your browser, go to `http://localhost:8084` to open the APIM UI. You can log in with the Username `admin` and Password `admin`.
