...
NOTE: If you want to change the default configuration for any of the component images (such as the URL of APIM API for the UI components), see the relevant component section in link:{{ '/apim/3.x/apim_installguide_docker_images.html' | relative_url }}[APIM Docker Images^].
