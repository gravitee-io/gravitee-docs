...
As for Management repositories, you can define a custom prefix for rate limit table or collection name.

==== Store counters in MongoDB

NOTE: If you want to use a custom prefix, you have to follow the following link:apim_installguide_repositories_mongodb.html#use_a_custom_prefix[instructions]
...
NOTE: If you want to use a custom prefix, you have to follow the following link:apim_installguide_repositories_jdbc.html#use_a_custom_prefix[instructions]
