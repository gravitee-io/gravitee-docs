...
[[use-a-custom-prefixs]]
== Use a custom prefix

From APIM 3.7, you can use a custom prefix for your tables name. This is useful if you want to use the same databases for APIM and AM, for example.
