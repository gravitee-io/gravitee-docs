...
NOTE: Because the plugin is part of the default distribution from APIM version 3.5, you only need to complete steps 1 and 2 steps for version 3.4 or earlier. The drivers (steps 3, 4, and5) may need to be installed for all versions.
