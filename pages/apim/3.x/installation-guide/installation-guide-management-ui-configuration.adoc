...
.Gravitee.io - Home ('/')
image::apim/3.x/themes/gravitee-io-homepage.png[Gravitee.io - Home ('/')]

.Gravitee.io - APIs List ('/apis')
image::apim/3.x/themes/gravitee-io-apisList.png[Gravitee.io - APIs List ('/apis')]

.Gravitee.io - API ('/apis/:idApi')
image::apim/3.x/themes/gravitee-io-api.png[Gravitee.io - API ('/apis/:idApi')]
