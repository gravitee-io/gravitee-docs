...
link:{mongodb-scripts-dir}/3.3.0/1-update-users-and-identityProviders.js[/apim/3.x/mongodb/3.3.0/1-update-users-and-identityProviders.js]::
This script replaces *referenceId* and *referenceType* with *organizationId* for `users` and `identity_providers` collections.

link:{mongodb-scripts-dir}/3.3.0/2-update-json-validation-policy-scopes.js[/apim/3.x/mongodb/3.3.0/2-update-json-validation-policy-scopes.js]::
