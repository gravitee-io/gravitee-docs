...
This section describes how to install the full APIM stack, including all the components (API Gateway, Management API, Portal)
...
Ensure that you have configured your package management, as described in <<apim_installguide_amazon_introduction.adoc#configure-the-package-management-system-yum, Configure the package management system (yum)>>.
