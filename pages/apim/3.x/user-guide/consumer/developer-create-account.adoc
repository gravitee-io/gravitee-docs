...
image::apim/3.x/graviteeio-developer-create-account-activate-settings.png[]
...
image::apim/3.x/graviteeio-developer-create-account-login-form.png[]

=== Sign in

Where he will find a link to sign in, and will be redirected to a registration form:

image::apim/3.x/graviteeio-developer-create-account-signin-form.png[]
...
image::apim/3.x/graviteeio-developer-create-account-email-registration.png[]
...
image::apim/3.x/graviteeio-developer-create-account-link-expire.png[]
...
image::apim/3.x/graviteeio-developer-create-account-confirm-registration.png[]