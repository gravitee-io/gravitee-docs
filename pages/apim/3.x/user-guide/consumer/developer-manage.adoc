...
You can manage applications in both APIM Management and APIM Portal.
...
. (Optional) Search for an API and request a subscription (see link:/apim/3.x/apim_quickstart_consume.html[Quick Start > Consume an API]). Click *NEXT*.
