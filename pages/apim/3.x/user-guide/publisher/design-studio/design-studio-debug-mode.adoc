...
* *Encrypted properties* - For security reasons, you won't be able to cleared encrypted properties in debug mode (it could have impact if you want to use them in condition for example).
