...
.Create API Options
image::apim/3.x/graviteeio-create-api-options.png[Create API Options]
...
image::apim/3.x/graviteeio-create-api-swagger-1.png[Import Swagger 1]

.Step2: Change values from the Swagger descriptor if required
image::apim/3.x/graviteeio-create-api-swagger-2.png[Import Swagger 2]

.Step3: Set the context-path
image::apim/3.x/graviteeio-create-api-swagger-3.png[Import Swagger 3]
...
.Step3: Good job guy !
image::apim/3.x/graviteeio-create-api-swagger-4.png[Import Swagger 4]
