...
The link:/apim/3.x/apim_quickstart_publish.html[Quick Start Guide] gives you a quick introduction to creating a new API from scratch.

If you click the plus icon image:apim/3.x/icons/plus-icon.png[] at the bottom of the API page, you can see that there are other ways you can create an API in APIM:
...
The following sections explain the different ways to create an API using APIM Console.
