...
The value of this field is an Object that follows this link:https://raw.githubusercontent.com/gravitee-io/gravitee-management-rest-api/master/gravitee-rest-api-service/src/main/resources/schema/xGraviteeIODefinition.json[JSON Schema, window="_blank"]
...
Once you have finished, you just need to select all the APIs you want.
