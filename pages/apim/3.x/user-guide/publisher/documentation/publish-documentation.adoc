...
=== System folders
You use system folders to customize the APIM Portal menu header, footer and navigation by adding custom links. +
...
* Markdown (for more information, see link:/apim/3.x/apim_publisherguide_publish_documentation_markdown.html[Markdown documentation]). You can also create Markdown templates to kickstart new Markdown pages.
...
. In APIM Console, open *Settings > Documentation*.
