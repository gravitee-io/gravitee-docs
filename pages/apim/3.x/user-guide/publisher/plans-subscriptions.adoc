...
OAuth 2.0 plans ensure that access tokens provided by third party OAuth 2.0 authorization servers are valid. Only apps with approved OAuth 2.0 access tokens can access APIs associated with an OAuth2 plan.
