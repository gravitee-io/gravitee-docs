...
You manage plans as part of the API creation process or in the *Portal > Plans* function in APIM Console. For more details, see the link:/apim/3.x/apim_quickstart_publish_ui.html[Publish your first API with APIM Management].
