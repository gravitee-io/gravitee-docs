...
image::apim/3.x/graviteeio-page-documentation-swagger-configuration.png[]
...
image::apim/3.x/graviteeio-page-documentation-draft.png[]
...
image::apim/3.x/graviteeio-page-documentation.png[]
