...
In the installation guide, you have learnt how to configure different identity providers (see link:/apim/3.x/apim_installguide_management_api_configuration.html#authentication_type[how to configure authentication]).
...
image::apim/3.x/adminguide/usersgroups-groupmembers.png[Gravitee.io - Group member]
