...
Platform flows are executed before and after any API Flow of the organization. They can be defined in the organization settings and are automatically deployed on every change.
