...
To be more precise, an environment's scope is all of the actions that can be performed in the specific context, in APIM Portal and APIM Console.
...
As the name suggests, the scope of an _organization_ is all aspects of an organization: users, roles, and so on. These actions are only available in APIM Console.
