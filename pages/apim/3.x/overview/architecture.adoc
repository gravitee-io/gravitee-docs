...
image::apim/3.x/architecture/graviteeio-global-architecture.png[Gravitee.io - Global Architecture]

.Gravitee.io - Platform Architecture
image::apim/3.x/architecture/graviteeio-platform-architecture.png[Gravitee.io - Platform Architecture]
