...
When a feature or a bug fix require an update of the link:https://docs.gravitee.io[online documentation, window="_blank"], the `pull request` on the `gravitee-docs` repository must be done before passing the github issue in `in review`.
