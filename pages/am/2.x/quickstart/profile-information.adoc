...
. Retrieve your public key by clicking on image:{% link images/am/2.x/graviteeio-am-quickstart-profile-public-key.png %}[] icon
...
image::{% link images/am/2.x/graviteeio-am-quickstart-profile-user-mappers.png %}[]
