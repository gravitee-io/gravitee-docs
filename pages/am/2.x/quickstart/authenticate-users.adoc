...
image::am/2.x/graviteeio-am-quickstart-idp-type.png[align=center, title-align=center]

[start=6]
. Give your identity provider a *name* and create a user by filling out the user form and press `CREATE`

image::am/2.x/graviteeio-am-quickstart-create-idp.png[align=center, title-align=center]
...
image::am/2.x/graviteeio-am-quickstart-client-idp.png[align=center, title-align=center]
