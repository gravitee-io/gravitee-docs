...
image::am/2.x/graviteeio-am-userguide-create-certificate.png[align=center, title-align=center]
...
. From `Certificates` list page, click image:am/graviteeio-am-quickstart-profile-public-key.png[] button.
. You can copy/paste the public to use them with third party library to verify your tokens

image::am/2.x/graviteeio-am-userguide-public-key.png[align=center, title-align=center]
...
image::am/2.x/graviteeio-am-userguide-custom-certificate.png[align=center, title-align=center]
