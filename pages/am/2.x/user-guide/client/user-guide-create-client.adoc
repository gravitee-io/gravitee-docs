...
image::am/2.x/graviteeio-am-userguide-client-settings.png[align=center, title-align=center]
...
image::am/2.x/graviteeio-am-userguide-client-oidc.png[align=center, title-align=center]
