...
NOTE: Look and feel of the Login form and Registration form can be overridden. See link:/am_userguide_user_management_forms.html[Custom forms] for more information.
