...
:page-permalink: am_quickstart_register_app.html
...
http://GRAVITEEIO-AM-UI-HOST (see link:/am_installguide_portal.html[Gravitee.io AM Management UI installation] for more information)
...
image::graviteeio-am-oauth-client.png[align=center, title-align=center]
