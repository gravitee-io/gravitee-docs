...
:page-permalink: am_quickstart_secure_apis.html
:page-folder: am/quickstart


image::graviteeio-am-quickstart-secure-apis-overview.png[align=center, title-align=center]
...
NOTE: Make sure you have completed the link:/am_quickstart_register_app.html[Register a new client^] quick start and grab your Client ID, Client Secret and Security Domain information.
...
image::graviteeio-am-quickstart-secure-apis-resource.png[align=center, title-align=center]
...
image::graviteeio-am-quickstart-quickstart-secure-apis-policy.png[align=center, title-align=center]
