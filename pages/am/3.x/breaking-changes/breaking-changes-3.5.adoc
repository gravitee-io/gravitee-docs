...
NOTE: All `/domains/:domainId/policies/**` routes have been removed for this version. See the new link:/am/current/management-api/index.html[AM v3 OpenAPI descriptor] for more information.
