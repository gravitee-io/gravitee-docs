= Breaking changes in 3.20.11
:page-sidebar: am_3_x_sidebar
:page-permalink: am/current/am_breaking_changes_3.20.11.html
...
We have introduced a unique constraint on the `username` field  in the **users** collection/table in AM version 3.20.11.
...
As a result you may experience issues while upgrading AM from any previous version to 3.20.11 in case the **users** collection/table already has more than one user with the same user name in the `username` field.
