...
Please use the link:https://tools.ietf.org/html/rfc7662[RFC] compliant `/oauth/introspect` link:{{ '/am/current/oauth2/index.html#tag/OAuth-2.0%2Fpaths%2F~1introspect%2Fpost' | relative_url }}[endpoint] to determine the active state of an OAuth 2.0 token.
