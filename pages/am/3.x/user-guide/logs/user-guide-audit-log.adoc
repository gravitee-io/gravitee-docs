...
+
image::{% link images/am/current/graviteeio-am-userguide-logs-audit.png %}[]

NOTE: All of this information can also be retrieved with the link:{{ '/am/current/management-api/index.html#tag/audit' | relative_url }}[AM API].
