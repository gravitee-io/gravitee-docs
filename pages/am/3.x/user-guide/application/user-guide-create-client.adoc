...
The quickest way to test your newly created application is to request an OAuth2 access token, as described in link:/am_quickstart_app_setup.html[Set up your first application^].
