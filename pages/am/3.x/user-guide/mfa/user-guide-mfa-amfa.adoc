...
WARNING: To apply location rules, you must first install plugin link:https://download.gravitee.io/plugins/services/gravitee-service-geoip/gravitee-service-geoip-1.1.0.zip[`gravitee-service-geoip`].
...
NOTE: In order to use the geoip features, you can download the link:https://download.gravitee.io/#plugins/services/gravitee-service-geoip/[Gravitee Geoip Plugin]
