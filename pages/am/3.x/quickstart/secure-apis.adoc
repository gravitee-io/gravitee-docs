...
Ensure you have link:/am/current/am_quickstart_app_setup.html[set up a new application^] and have your Client ID, Client Secret and Security Domain information to hand.
