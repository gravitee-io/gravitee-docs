...
NOTE: If you want to change the default configuration for any of the component images , see the relevant component section in link:{{ '/am/3.x/apim_installguide_docker_images.html' | relative_url }}[AM Docker images^].
