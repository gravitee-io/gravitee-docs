...
:page-permalink: am_userguide_identity_provider_mapping.html
...
image::graviteeio-am-userguide-idp-user-mappers.png[align=center, title-align=center]
...
image::graviteeio-am-userguide-idp-role-mappers.png[align=center, title-align=center]
