...
:page-permalink: am_userguide_create_identity_provider.html
...
image::graviteeio-am-quickstart-create-idp.png[align=center, title-align=center]
...
image::graviteeio-am-userguide-ldap-idp.png[align=center, title-align=center]
...
image::graviteeio-am-userguide-custom-idp.png[align=center, title-align=center]
...
The fastest way to test your fresh created identity provider is to request for an OAuth2 access token by following the link:/am_quickstart_authenticate_users.html[Authenticate users with Identity Provider] tutorial.
