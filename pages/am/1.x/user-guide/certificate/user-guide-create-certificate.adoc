...
image::{% link images/am/1.x/graviteeio-am-userguide-create-certificate.png %}[]
...
. From `Certificates` list page, click image:{% link images/am/1.x/graviteeio-am-quickstart-profile-public-key.png %}[] button.
. You can copy/paste the public to use them with third party library to verify your tokens

image::{% link images/am/1.x/graviteeio-am-userguide-public-key.png %}[]
...
image::{% link images/am/1.x/graviteeio-am-userguide-custom-certificate.png %}[]
