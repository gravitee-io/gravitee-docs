...
image::am/1.x/graviteeio-am-quickstart-create-idp.png[align=center, title-align=center]
...
image::am/1.x/graviteeio-am-userguide-ldap-idp.png[align=center, title-align=center]
...
image::am/1.x/graviteeio-am-userguide-custom-idp.png[align=center, title-align=center]
