...
image::am/1.x/graviteeio-am-userguide-idp-user-mappers.png[align=center, title-align=center]
...
image::am/1.x/graviteeio-am-userguide-idp-role-mappers.png[align=center, title-align=center]
