...
image::am/1.x/graviteeio-am-quickstart-idp-type.png[align=center, title-align=center]
...
image::am/1.x/graviteeio-am-quickstart-client-idp.png[align=center, title-align=center]
