...
image::{% link images/am/1.x/graviteeio-am-quickstart-secure-apis-overview.png %}[]
...
image::{% link images/am/1.x/graviteeio-am-quickstart-secure-apis-resource.png %}[]
...
image::{% link images/am/1.x/graviteeio-am-quickstart-quickstart-secure-apis-policy.png %}[]
