...
There are three different ways to configure the Alert Engine (AE) component:
...
You can override the default `gravitee.yml` and system properties by defining environment variables.
