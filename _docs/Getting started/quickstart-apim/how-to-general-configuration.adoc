...
permalink: apim/current/apim_getstarted_configureAPIM.html
tags: [APIM]
toc: true
...
link:/apim/current/apim_installguide_rest_apis_configuration.html[Configure APIM API^].

NOTE: APIM includes many other configuration options and every environment is unique. We recommend you also read the link:/apim/3.x/apim_configurationguide.html[Configuration Guide^] to make sure you've completed all the configuration you need, before you deploy APIM in production.
