---
redirect_from:
  - /apim/3.x/apim_publisherguide_expression_language.html
---
= Expression Language
...
Additionally, some policies (like the link:/Reference/policy/policies-oauth2.html#attributes[OAuth2 policy])
