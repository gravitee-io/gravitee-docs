...
NOTE: Make sure you have completed the link:/am/current/am_quickstart_register_app.html[Register a new application^] quick start and grab your Client ID, Client Secret and Security Domain information.
...
== Request access token for your application
