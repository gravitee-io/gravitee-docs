...
We assume that you have link:../APIM/installation-quickstart.html[installed Gravitee.io API Management^] and have a fully operational environment which can interact with your published APIs.
