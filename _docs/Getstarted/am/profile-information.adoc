---
redirect_from:
  - /am/current/am_quickstart_profile_information.html
---
...
TIP: You can find more information about User mapping in the link:/Guides/AM/current/user-guide/identity-provider/mapping-identity-provider.html[User Guide^].
