---
redirect_from:
  - /apim/3.x/apim_quickstart_publish_ui.html
---
= Publish your first API with APIM Console

This section walks you through creating and publishing your first API with APIM Console. To learn more about creating and publishing APIs, see the link:/Guides/APIM/current/publisher-guide/introduction.html[API Publisher Guide^].
...
+
NOTE: Ensure you set the link:/apim/3.x/apim_policies_apikey.html[API Key^] **security type**. For more information about plan configuration, see link:/apim/3.x/apim_publisherguide_plans_subscriptions.html[Plans and subscriptions^].
