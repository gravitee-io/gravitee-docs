---
redirect_from:
  - /apim/3.x/apim_quickstart_consume_ui.html
---
= Subscribe to an API with APIM Portal
...
NOTE: APIM includes several ways to access and secure an API, as described in link:/Guides/APIM/current/publisher-guide/plans/plans-subscriptions.html[Plans & subscriptions^].
