---
redirect_from:
  - /cockpit/3.x/cockpit_installguide_management_api_install_zip.html
---
= Install Cockpit API
:page-liquid:
...
Cockpit API is required to run Cockpit Console. You must install Cockpit API first before you can use Cockpit Console.
