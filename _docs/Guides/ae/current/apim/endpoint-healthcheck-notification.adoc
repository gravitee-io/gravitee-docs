---
redirect_from:
  - /ae/apim_notification_endpoint_healthcheck.html
---
...
This page lists the properties available in all alerts triggered by an `ENDPOINT_HEALTHCHECK` event. For more information about notifications in AE, see the link:../user-guide/notifiers/introduction.html[Notifications^] section of the User Guide.
