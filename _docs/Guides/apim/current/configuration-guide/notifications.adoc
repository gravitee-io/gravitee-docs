...
=== Attributes
You can use the http://freemarker.org[Freemarker template engine] to add specific information to your templates (for example `${user.name}` or `${api.metadata['foo-bar']`}.
