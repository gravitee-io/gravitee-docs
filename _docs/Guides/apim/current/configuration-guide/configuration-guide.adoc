...
The following sections explain how to configure APIM after installation. For a quick guide to configuring a new environment after installation, see link:/Getstarted/how-to-general-configuration.html[How to configure a production-ready APIM environment^]
