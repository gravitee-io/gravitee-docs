...
link:./introduction.html#configuring_apim_gateway_and_apim_api[Learn more about the different ways you can configure APIM API^]
...
See the link:../authentication/introduction.html[Authentication configuration^] section.
