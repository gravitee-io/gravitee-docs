...
This page explains how to enable APIM authentication using Google accounts.
...
. Click *CREATE*.
. Activate the provider for Portal or Console login, as described in link:../configuration-guide/authentication/configure-authentication#activating-providers[Activating providers^].
