---
redirect_from:
  - /apim/3.x/apim_installguide_authentication_graviteeam.html
---
= Configure Access Management authentication
...
See link:/Getstarted/quickstart-am/setup-app.html[Set up your first application^] in the AM documentation for guidance on setting up your first security domain and client application.
...
See link:/Getstarted/quickstart-am/setup-app.html[Set up your first application^] for guidance on setting up your new AM user.
