---
redirect_from:
  - /apim/3.x/apim_installguide_authentication_google.html
---
...
. Click the plus icon image:icons/plus-icon.png[role="icon"] and select the *Google* icon.
...
+
image::apim/3.x/installation/authentication/google_login_success.png[]
