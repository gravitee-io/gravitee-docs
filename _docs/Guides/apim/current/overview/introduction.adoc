...
NOTE: Want to know how to create, use, and deploy a custom policy? Check out the link:../dev-guide/dev-guide-policies.html[Policies Developer Guide].
...
You can find more information in the link:../configuration-guide/repositories/configure-repositories.html[Repositories] section of the Configuration Guide.
...
You can find more information in the link:../publisher-guide/resources/resources-overview.html[Resources] section of the API Publisher Guide.
