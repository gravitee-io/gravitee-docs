---
redirect_from:
  - /apim/3.x/apim_adminguide_roles_and_permissions.html
---
...
Before defining some key concepts, we recommend you first take a look at the new link:./organizations-environments.html[Gravitee.io Platform design^].
...
Roles are defined in terms of _scopes_. As described in the link:./organizations-environments.html[Organizations and environments] page, an _environment_ corresponds roughly to what you can find in APIM Portal.
...
. In APIM Console, click **Organization Settings**.
