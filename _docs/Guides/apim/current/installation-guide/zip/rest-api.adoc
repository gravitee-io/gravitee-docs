...
NOTE: Both APIM API nodes run by default. You can configure APIM to run only one or the other, as described in the link:../../configuration-guide/rest-apis/general-configuration.html[APIM API configuration] section.
