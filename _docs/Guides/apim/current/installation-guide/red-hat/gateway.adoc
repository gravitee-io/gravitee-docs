---
redirect_from:
  - /apim/3.x/apim_installguide_redhat_gateway.html
---
...
The following steps assume you have configured your package management system as ../amazon-linux/configure-yum.html[Configure YUM].
