---
redirect_from:
  - /apim/3.x/apim_installguide_redhat_introduction.html
---
...
Now, you can ./stack.html[install all four APIM components as a full stack], or install each component individually.
