...
NOTE: This section gives a general overview of creating hybrid deployments. Have a look at this link:/Reference/apim/hybrid-deployment-k8s.html[case study^] for an example of how to implement it in Kubernetes.
