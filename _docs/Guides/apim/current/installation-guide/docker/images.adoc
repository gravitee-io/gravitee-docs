---
redirect_from:
  - /apim/3.x/apim_installguide_docker_images.html
---
= Run the APIM images
...
you need to use environment variables. For more information, see the APIM Gateway link:../../configuration-guide/gateway/general-config.html#environment_variables[configuration] section.
...
If you want to override the default configuration for MongoDB, Elasticsearch and any other properties included in the `gravitee.yml` file,
you have to use environment variables. For more information, see the APIM API link:../../configuration-guide/gateway/general-config.html#environment_variables[configuration] section.
