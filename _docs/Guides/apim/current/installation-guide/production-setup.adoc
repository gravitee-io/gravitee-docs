---
redirect_from:
  - /apim/3.x/apim_how_to_configuration.html
tags: [APIM]
---
...
link:/Guides/APIM/current/configuration-guide/api/general-config.html[Configure APIM API^].
...
* link:/Guides/APIM/current/configuration-guide/api/internal-api.html[Configure the APIM API internal API^]
