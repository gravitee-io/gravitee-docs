...
You design your APIs by adding and configuring new _flows_ at both API and plan level. You can then customize your flows with link:../../introduction.html#gravitee-plugins-policies[Policies^] and link:../../introduction.html#gravitee-plugins-resources[Resources^].
