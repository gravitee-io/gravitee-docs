---
redirect_from:
  - /apim/3.x/apim_publisherguide_design_studio_migrate.html
---
...
For more information on the differences between the APIM Console *Design* function and Design Studio, see link:./introduction.html#differences[Differences between Design function and Design Studio^].
