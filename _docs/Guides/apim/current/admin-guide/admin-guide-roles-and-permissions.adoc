...
Before defining some key concepts, we recommend you first take a look at the new link:../admin-guide-organizations-and-environments.html[Gravitee.io Platform design^].
...
Roles are defined in terms of _scopes_. As described in the link:../admin-guide-organizations-and-environments.html[Organizations and environments] page, an _environment_ corresponds roughly to what you can find in APIM Portal.
...
. In APIM Console, navigate to the *Organization Settings > Roles* page.
