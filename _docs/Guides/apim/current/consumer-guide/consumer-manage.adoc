...
NOTE: Only users with the required permissions can create an application. For more details, see the link:../admin-guide/admin-guide-roles-and-permissions.html[Roles and permissions] section of the Administration Guide.
...
. (Optional) Search for an API and request a subscription (see link:/Getstarted/quickstart-apim/api-consumer-ui.html[Consume an API with APIM Portal]) in the Quick Start Guide. Click *NEXT*.
...
NOTE: Only users with the required permissions can manage application members. For more details, see the link:../admin-guide/admin-guide-roles-and-permissions.html[Roles and permissions] section of the Administration Guide.
