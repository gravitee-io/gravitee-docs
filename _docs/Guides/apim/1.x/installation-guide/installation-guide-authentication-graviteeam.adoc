...
image::apim/1.x/installation/authentication/graviteeam_client_credentials.png[Get Client credentials]
...
image::apim/1.x/management-api-configuration-idp/new-am.png[Gravitee.io - New Gravitee.io AM IDP]
...
.Create a user
image::apim/1.x/installation/authentication/graviteeam_create_user.png[Fill the user form]

=== Login into the portal
.Login Form
image::apim/1.x/installation/authentication/graviteeam_login_form.png[Login Form]

.Gravitee.io AM Login Form
image::apim/1.x/installation/authentication/graviteeam_login_form2.png[Gravitee.io Login Form]

.OPTIONAL : Gravitee.io AM Approval page
image::apim/1.x/installation/authentication/graviteeam_login_form3.png[Gravitee.io Approval Page]

.Login Success
image::apim/1.x/installation/authentication/graviteeam_login_success.png[Here we are !]