...
permalink: apim/current/apim_installguide_amazon_fullstack.html
toc: true
...
= Install the full APIM stack on Amazon Linux

This section describes how to install the full APIM stack on Amazon Linux, including all the components and, optionally, the dependencies (MongoDB, Elasticsearch).
...
* link:/apim/3.x/apim_installguide_amazon_management_ui.html[Install APIM Management]
