...
permalink: apim/current/apim_consumerguide_create_account.html
...
* email link:/apim/3.x/apim_installguide_rest_apis_configuration.html#smtp-configuration[SMTP configuration^]
