...
permalink: apim/current/apim_publisherguide_plans_subscriptions.html
toc: true
...
A plan provides a service and access layer on top of your API for consumer applications.
