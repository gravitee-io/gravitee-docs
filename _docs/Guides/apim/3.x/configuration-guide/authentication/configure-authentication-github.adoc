...
permalink: apim/current/apim_configguide_authentication_github.html
...
This page explains how to enable APIM authentication using https://github.com/[GitHub^] accounts.
...
. Click *CREATE*.
. Activate the provider for Portal or Console login, as described in link:/apim/3.x/apim_configguide_authentication.html#activating-providers[Activating providers^].
