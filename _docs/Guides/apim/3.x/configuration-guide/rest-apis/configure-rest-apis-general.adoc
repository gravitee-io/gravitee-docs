...
permalink: apim/current/apim_configguide_api_configuration.html
...
link:/apim/current/apim_configurationguide.html#configuring_apim_gateway_and_apim_api[Learn more about the different ways you can configure APIM API^]
