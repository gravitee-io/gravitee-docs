...
The following sections explain how to configure APIM after installation. For a quick guide to configuring a new environment after installation, see link:../installation-guide/production-setup.html[Configure a production-ready APIM environment^].
