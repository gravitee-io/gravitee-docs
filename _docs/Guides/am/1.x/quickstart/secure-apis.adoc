...
We assume that you have completed the installation of link:/Guides/apim/current/installation-guide/introduction.html[Gravitee.io API Management^] and have a fully operational environment capable of interacting with your APIs (see link:/apim_quickstart_publish.html[Publish your first API^])
