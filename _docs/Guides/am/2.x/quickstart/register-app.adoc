...
http://GRAVITEEIO-AM-UI-HOST (see link:/am/2.x/am_installguide_management_ui_install_zip.html[Gravitee.io AM Management UI installation^] for more information)
