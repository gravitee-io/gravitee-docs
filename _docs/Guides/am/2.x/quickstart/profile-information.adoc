...
TIP: more information about User mapping to be found in the dedicated section: link:/am/2.x/am_userguide_identity_provider_mapping.html[User and role mapping^].
