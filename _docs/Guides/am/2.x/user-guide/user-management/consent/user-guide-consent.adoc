...
NOTE: Look and feel of the User consent dialog form can be overridden. See link:/am/2.x/am_userguide_user_management_forms.html[Custom forms] for more information.
