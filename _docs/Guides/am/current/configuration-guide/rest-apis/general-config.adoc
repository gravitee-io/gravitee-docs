---
redirect_from:
  - /am/current/am_installguide_management_api_configuration.html
---
= Configure AM API
:page-liquid:
...
You can configure AM API using the configuration file, system variables, or environment variables.

link:../introduction.html#configuring_am_gateway_and_am_api[Learn more about the different ways you can configure AM API^]
