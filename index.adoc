 ...
 * link:{{ '/apim/3.x/apim_kubernetes_overview.html' | relative_url}}[Kubernetes Controller]
...
* link:{{ '/cockpit/3.x/cockpit_installguide_introduction.html' | relative_url}}[Configuration Guide]
