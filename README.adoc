...
This documentation applies to Gravitee versions prior to the 4.0 release. For version 4.0 documentation, click [here](https://github.com/gravitee-io/gravitee-platform-docs)

CAUTION: **THIS DOCUMENTATION APPLIES TO GRAVITEE VERSIONS RELEASED PRIOR TO 4.0. FOR GRAVITEE 4.0 DOCUMENTATION, CLICK** [**HERE**](../../overview/introduction-to-gravitee-api-management-apim/ee-vs-oss.md)**.**
